...
<form id="finder-search" action="<?php echo JRoute::_($this->query->toUri()); ?>" method="get" class="form-inline">
	...
	<fieldset class="word">
		<div class="input-group">
			...
			<input type="text" name="q" id="q" size="30" value="<?php echo $this->escape($this->query->input); ?>" class="inputbox form-control" placeholder="<?php echo JText::_('COM_FINDER_SEARCH_TERMS'); ?>" />
			<?php if ($this->escape($this->query->input) != '' || $this->params->get('allow_empty_query')) : ?>
			<span class="input-group-btn">
				<button name="Search" type="submit" class="btn btn-default"><i class="fa fa-search" aria-hidden="true"></i> <?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?></button>
			</span>
			<?php else : ?>
				<span class="input-group-btn">
					<button name="Search" type="submit" class="btn btn-default"><i class="fa fa-search" aria-hidden="true"></i> <?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?></button>
